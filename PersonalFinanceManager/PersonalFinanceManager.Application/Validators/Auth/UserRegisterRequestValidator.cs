...
public class UserRegisterRequestValidator : AbstractValidator<CreateUserCommand>
{
    ...
    {
        RuleFor(u => u.UserRegisterRequest.UserName)
        .Cascade(CascadeMode.Stop)
        .NotEmpty();

        RuleFor(u => u.UserRegisterRequest.Password)
             .Cascade(CascadeMode.Stop)
             .NotNull()
        ...
        RuleFor(u => u.UserRegisterRequest.ConfirmPassword)
            .Cascade(CascadeMode.Stop)
            .Equal(u => u.UserRegisterRequest.Password)
            .WithMessage("Password confirmed must be equal to the password");

        RuleFor(u => u.UserRegisterRequest.Email)
            .Cascade(CascadeMode.Stop)
