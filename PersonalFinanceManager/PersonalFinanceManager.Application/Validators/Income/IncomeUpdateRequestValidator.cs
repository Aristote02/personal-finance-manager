...
public class IncomeUpdateRequestValidator : AbstractValidator<IncomeUpdateRequest>
{
    public IncomeUpdateRequestValidator()
    {
        RuleFor(income => income.Id)
            .NotEqual(Guid.Empty).WithMessage("Income Id is required");
